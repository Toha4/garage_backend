...
class SyncingEmployees:
    ...
    def __update_employee(self, employee: dict):
        ...
        first_name = change_register(employee["first_name"])
        last_name = change_register(employee["last_name"])
        patronymic = change_register(employee["patronymic"])

        if updated_employee:
            updated_employee.first_name = first_name
            updated_employee.last_name = last_name
            updated_employee.patronymic = patronymic
